...
public class ItemHeadPhonesYellow extends Item {

	public ItemHeadPhonesYellow() {
		this.setMaxStackSize(1);
		this.setRegistryName("headphone_yellow");
		this.setUnlocalizedName("headphone_yellow");
	}
