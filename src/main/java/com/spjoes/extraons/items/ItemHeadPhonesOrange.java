...
public class ItemHeadPhonesOrange extends Item {

	public ItemHeadPhonesOrange() {
		this.setMaxStackSize(1);
		this.setRegistryName("headphone_orange");
		this.setUnlocalizedName("headphone_orange");
	}
