...
public class ItemHeadPhonesRainbow extends Item {

	public ItemHeadPhonesRainbow() {
		this.setMaxStackSize(1);
		this.setRegistryName("headphone_rainbow");
		this.setUnlocalizedName("headphone_rainbow");
	}
