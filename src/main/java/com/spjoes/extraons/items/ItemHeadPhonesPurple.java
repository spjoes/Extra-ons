...
public class ItemHeadPhonesPurple extends Item {

	public ItemHeadPhonesPurple() {
		this.setMaxStackSize(1);
		this.setRegistryName("headphone_purple");
		this.setUnlocalizedName("headphone_purple");
	}
